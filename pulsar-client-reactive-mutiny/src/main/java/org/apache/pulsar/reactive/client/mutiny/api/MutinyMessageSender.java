...
/**
 * Mutiny message sender interface.
 *
 * @param <T> the message payload type
 */
public interface MutinyMessageSender<T> {
	 ...
	 */
	Uni<MessageId> sendOne(MessageSpec<T> messageSpec);
	 ...
	 */
	Multi<MessageSendResult<T>> sendMany(Publisher<MessageSpec<T>> messageSpecs);
