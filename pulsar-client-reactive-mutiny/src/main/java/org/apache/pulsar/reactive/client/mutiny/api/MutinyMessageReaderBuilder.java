...
/**
 * Builder interface for {@link MutinyMessageReader}.
 *
 * @param <T> the message payload type
 */
public interface MutinyMessageReaderBuilder<T> {

	/**
	 * Gets the mutable spec of this builder.
	 * @return the mutable spec of this builder
	 */
	 ...
	 */
	MutinyMessageReaderBuilder<T> startAtSpec(StartAtSpec startAtSpec);
	 ...
	 * @return the reader builder instance
	 */
	MutinyMessageReaderBuilder<T> endOfStreamAction(EndOfStreamAction endOfStreamAction);
	 ...
	 * @return the reader builder instance
	 */
	default MutinyMessageReaderBuilder<T> applySpec(ReactiveMessageReaderSpec readerSpec) {
		getMutableSpec().applySpec(readerSpec);
		return this;
	}

	/**
	 * Creates and returns a copy of this mutiny reader builder.
	 * @return the cloned mutiny reader builder
	 */
	MutinyMessageReaderBuilder<T> clone();

	/**
	 * Builds the mutiny reader.
	 * @return the built mutiny reader
	 */
	MutinyMessageReader<T> build();
	 ...
	 */
	default MutinyMessageReaderBuilder<T> topic(String topicName) {
	 ...
	 * @see ReaderBuilder#topic(String)
	 */
	default MutinyMessageReaderBuilder<T> topic(String... topicNames) {
	 ...
	 */
	default MutinyMessageReaderBuilder<T> topics(List<String> topicNames) {
	 ...
	 */
	default MutinyMessageReaderBuilder<T> readerName(String readerName) {
	 ...
	 */
	default MutinyMessageReaderBuilder<T> subscriptionName(String subscriptionName) {
	 ...
	 *
	 */
	default MutinyMessageReaderBuilder<T> generatedSubscriptionNamePrefix(String generatedSubscriptionNamePrefix) {
	 ...
	 */
	default MutinyMessageReaderBuilder<T> receiverQueueSize(Integer receiverQueueSize) {
	 ...
	 */
	default MutinyMessageReaderBuilder<T> readCompacted(Boolean readCompacted) {
	 ...
	 */
	default MutinyMessageReaderBuilder<T> keyHashRanges(List<Range> keyHashRanges) {
	 ...
	 */
	default MutinyMessageReaderBuilder<T> cryptoKeyReader(CryptoKeyReader cryptoKeyReader) {
	 ...
	 */
	default MutinyMessageReaderBuilder<T> cryptoFailureAction(ConsumerCryptoFailureAction cryptoFailureAction) {
