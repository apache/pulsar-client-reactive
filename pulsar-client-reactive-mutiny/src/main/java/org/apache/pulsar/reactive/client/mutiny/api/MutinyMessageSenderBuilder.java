...
/**
 * Builder interface for {@link MutinyMessageSender}.
 *
 * @param <T> the message payload type
 */
public interface MutinyMessageSenderBuilder<T> {
	 ...
	 */
	MutinyMessageSenderBuilder<T> cache(ReactiveMessageSenderCache producerCache);
	 ...
	 * @return the sender builder instance
	 */
	MutinyMessageSenderBuilder<T> maxInflight(int maxInflight);
	 ...
	 * @return the sender builder instance
	 */
	MutinyMessageSenderBuilder<T> maxConcurrentSenderSubscriptions(int maxConcurrentSenderSubscriptions);
	 ...
	 * @return the sender builder instance
	 */
	default MutinyMessageSenderBuilder<T> applySpec(ReactiveMessageSenderSpec senderSpec) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> topic(String topicName) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> producerName(String producerName) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> sendTimeout(Duration sendTimeout) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> maxPendingMessages(int maxPendingMessages) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> maxPendingMessagesAcrossPartitions(int maxPendingMessagesAcrossPartitions) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> messageRoutingMode(MessageRoutingMode messageRoutingMode) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> hashingScheme(HashingScheme hashingScheme) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> cryptoFailureAction(ProducerCryptoFailureAction cryptoFailureAction) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> messageRouter(MessageRouter messageRouter) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> batchingMaxPublishDelay(Duration batchingMaxPublishDelay) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> roundRobinRouterBatchingPartitionSwitchFrequency(
	 ...
	 */
	default MutinyMessageSenderBuilder<T> batchingMaxMessages(int batchingMaxMessages) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> batchingMaxBytes(int batchingMaxBytes) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> batchingEnabled(boolean batchingEnabled) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> batcherBuilder(BatcherBuilder batcherBuilder) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> chunkingEnabled(boolean chunkingEnabled) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> cryptoKeyReader(CryptoKeyReader cryptoKeyReader) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> encryptionKeys(Set<String> encryptionKeys) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> compressionType(CompressionType compressionType) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> initialSequenceId(long initialSequenceId) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> autoUpdatePartitions(boolean autoUpdatePartitions) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> autoUpdatePartitionsInterval(Duration autoUpdatePartitionsInterval) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> multiSchema(boolean multiSchema) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> accessMode(ProducerAccessMode accessMode) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> lazyStartPartitionedProducers(boolean lazyStartPartitionedProducers) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> property(String key, String value) {
	 ...
	 */
	default MutinyMessageSenderBuilder<T> properties(Map<String, String> properties) {
		getMutableSpec().setProperties(properties);
		return this;
	}

	/**
	 * Builds the mutiny message sender.
	 * @return the mutiny message sender
	 */
	MutinyMessageSender<T> build();
