...
/**
 * Builder interface for {@link MutinyMessageConsumer}.
 *
 * @param <T> the message payload type
 */
public interface MutinyMessageConsumerBuilder<T> {
	...
	/**
	 * Creates and returns a copy of this mutiny consumer builder.
	 * @return the cloned mutiny reader builder
	 */
	MutinyMessageConsumerBuilder<T> clone();

	/**
	 * Builds the mutiny message consumer.
	 * @return the mutiny message consumer
	 */
	MutinyMessageConsumer<T> build();
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> applySpec(ReactiveMessageConsumerSpec consumerSpec) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> topic(String topicName) {
	 ...
	 * @see ConsumerBuilder#topic(String...)
	 */
	default MutinyMessageConsumerBuilder<T> topic(String... topicNames) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> topics(List<String> topicNames) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> topicsPattern(Pattern topicsPattern) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> topicsPatternSubscriptionMode(
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> topicsPatternAutoDiscoveryPeriod(
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> subscriptionName(String subscriptionName) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> subscriptionMode(SubscriptionMode subscriptionMode) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> subscriptionType(SubscriptionType subscriptionType) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> subscriptionInitialPosition(
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> keySharedPolicy(KeySharedPolicy keySharedPolicy) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> replicateSubscriptionState(boolean replicateSubscriptionState) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> subscriptionProperties(Map<String, String> subscriptionProperties) {
	 ...
	 * @see ConsumerBuilder#subscriptionProperties(Map)
	 */
	default MutinyMessageConsumerBuilder<T> subscriptionProperty(String key, String value) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> consumerName(String consumerName) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> properties(Map<String, String> properties) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> property(String key, String value) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> priorityLevel(Integer priorityLevel) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> readCompacted(boolean readCompacted) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> batchIndexAckEnabled(boolean batchIndexAckEnabled) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> ackTimeout(Duration ackTimeout) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> ackTimeoutTickTime(Duration ackTimeoutTickTime) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> acknowledgementsGroupTime(Duration acknowledgementsGroupTime) {
	 ...
	 * @return the consumer builder instance
	 */
	default MutinyMessageConsumerBuilder<T> acknowledgeAsynchronously(boolean acknowledgeAsynchronously) {
	 ...
	 * @return the consumer builder instance
	 */
	default MutinyMessageConsumerBuilder<T> acknowledgeScheduler(Scheduler acknowledgeScheduler) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> negativeAckRedeliveryDelay(Duration negativeAckRedeliveryDelay) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> deadLetterPolicy(DeadLetterPolicy deadLetterPolicy) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> retryLetterTopicEnable(boolean retryLetterTopicEnable) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> receiverQueueSize(Integer receiverQueueSize) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> maxTotalReceiverQueueSizeAcrossPartitions(
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> autoUpdatePartitions(boolean autoUpdatePartitions) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> autoUpdatePartitionsInterval(Duration autoUpdatePartitionsInterval) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> cryptoKeyReader(CryptoKeyReader cryptoKeyReader) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> cryptoFailureAction(ConsumerCryptoFailureAction cryptoFailureAction) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> maxPendingChunkedMessage(Integer maxPendingChunkedMessage) {
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> autoAckOldestChunkedMessageOnQueueFull(
	 ...
	 */
	default MutinyMessageConsumerBuilder<T> expireTimeOfIncompleteChunkedMessage(
